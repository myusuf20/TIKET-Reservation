...
namespace tiket_reservation.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        {
            Session.Remove("user"); Session.Remove("email"); Session.Remove("id");
        ...
        public ActionResult data_pembeli()
        {
            ...
            //Gabungan. student = db.Students.Find(id); gabungan.tblPembeli = db.pembeli.Find(idUser); gabungan.tblDetailTiket =
            ...
            gabungan.nm_bandara_tujuan = hargaTujuan.nm_bandara; return View(gabungan);
        }
        ...
        public ActionResult validasi_tiket()
        {
            ...
            gabungan.rp_harga_tiket = ConvertCurrency.ToRupiah(gabungan.tblDetailTiket.harga_tiket);
            int pajak_berangkatId = gabungan.tblDetailTiket.bandara_berangkat; int pajak_tujuanId = gabungan.tblDetailTiket.bandara_tujuan;
            var hargaBerangkat = db.pajak_bandara.Find(pajak_berangkatId);
            var hargaTujuan = db.pajak_bandara.Find(pajak_tujuanId);
            gabungan.rp_bandara_berangkat = ConvertCurrency.ToRupiah(hargaBerangkat.pajak); gabungan.rp_bandara_tujuan = ConvertCurrency.ToRupiah(hargaTujuan.pajak);
            gabungan.nm_bandara_berangkat = hargaBerangkat.nm_bandara;
